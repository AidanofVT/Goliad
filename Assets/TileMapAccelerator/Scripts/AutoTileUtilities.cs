...
namespace TileMapAccelerator.Scripts
{
    ...
    public static class AutoTileUtilities
    {
        ...
        public static byte NeighborhoodToAutoTileValue(TileNeighborhood n, uint a, uint b)
        {
            int toret = 0;
        ...
        public static byte NeighborhoodToAutoTileValue(TileNeighborhood n, HashSet<uint> a, uint b )
        {
            int toret = 0;

            toret += (n.northwest == b && a.Contains(n.north) && a.Contains(n.west)) ? 1 : 0;
            toret += (n.north == b) ? 2 : 0;
            toret += (n.northeast == b && a.Contains(n.north) && a.Contains(n.east)) ? 4 : 0;

            toret += (n.west == b) ? 8 : 0;
            toret += (n.east == b) ? 16 : 0;

            toret += (n.southwest == b && a.Contains(n.south) && a.Contains(n.west)) ? 32 : 0;
            toret += (n.south == b) ? 64 : 0;
            toret += (n.southeast == b && a.Contains(n.south) && a.Contains(n.east)) ? 128 : 0;
